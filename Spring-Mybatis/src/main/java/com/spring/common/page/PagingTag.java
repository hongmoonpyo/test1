...
public class PagingTag extends TagSupport {
	...
	public String getPaging() {
		...
		if (page > 1) {
			...
			ret += "<img src='/resources/images/common/btn_paginate_first.gif' alt='처음' />";
			ret += "</span></a> ";
		} else {
			ret += " <span><img src='/resources/images/common/";
			ret += "btn_paginate_first.gif' alt='처음' /></span> ";
		}
		if (prevFirst > 0) {
			ret += " <a href=\"javascript:goPage('" + prevFirst + "');\"><span>";
			ret += "<img src='/resources/images/common/btn_paginate_prev.gif' alt='이전' />";
			ret += "</span></a> ";
		} else {
			ret += " <span><img src='/resources/images/common/";
			ret += "btn_paginate_prev.gif' alt='이전' /></span> ";
		}
		...
		if (nextFirst <= lastPage) {
			...
			ret += "<img src='/resources/images/common/btn_paginate_next.gif' alt='다음' />";
			ret += "</span></a> ";

		} else {
			ret += " <span><img src='/resources/images/common/";
			ret += "btn_paginate_next.gif' alt='다음' /></span> ";
		}

		if (page < lastPage) {
			ret += " <a href=\"javascript:goPage('" + lastPage + "')\"><span>";
			ret += "<img src='/resources/images/common/btn_paginate_last.gif' alt='마지막' />";
			ret += "</span></a> ";
